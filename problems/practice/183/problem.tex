...
\begin{prob}
    The code for \mintinline{python}{quickselect} is shown below. It is the same
    as the code provided in lecture, except that it contains an added
    \mintinline{python}{print} statement.
    ...
    Suppose \mintinline{python}{quickselect(arr, 3, 0, 10)} is called with
    \mintinline{python}{arr = [5, 2, 8, 3, 1, 6, 9, 7, 4, 0]}.
