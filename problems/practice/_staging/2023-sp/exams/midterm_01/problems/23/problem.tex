...
\begin{prob}
    ...
    \inputminted[lastline=16]{python}{\thisdir/code.py}

    You may assume that the function is always called on a non-empty array,
    and with \python{start = 0} and \python{stop = len(arr)}.
