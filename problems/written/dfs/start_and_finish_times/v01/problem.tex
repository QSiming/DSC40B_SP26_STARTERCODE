...
\begin{subprobset}
                ...
                \begin{tikzpicture}
                    \drawgraph{}
                     \foreach \i/\j in {%
                         ...
                         \draw (n\i) edge[very thick, red, ->] (n\j);
                     }
                \end{tikzpicture}
            \end{center}
        \end{soln}
            ...
            \begin{center}
                \begin{tikzpicture}
                    \drawgraph
                     ...
                     \foreach \i/\j in {%
                         1/2, 2/3, 3/6, 6/5, 5/4, 5/7, 5/8, 8/9%
                     }{
                         \draw (n\i) edge[very thick, red, ->] (n\j);
                     }
                 \end{tikzpicture}
    ...
    \begin{subprob}
        ...
        \begin{center}
            \begin{tabular}{ccc}
                Node & Start & Finish\\
                1 & \inlineresponsebox[.5in]{1} & \inlineresponsebox[.5in]{18} \\
                2 & \inlineresponsebox[.5in]{2} & \inlineresponsebox[.5in]{17} \\
                3 & \inlineresponsebox[.5in]{3} & \inlineresponsebox[.5in]{16} \\
                4 & \inlineresponsebox[.5in]{6} & \inlineresponsebox[.5in]{7} \\
                5 & \inlineresponsebox[.5in]{5} & \inlineresponsebox[.5in]{14} \\
                6 & \inlineresponsebox[.5in]{4} & \inlineresponsebox[.5in]{15} \\
                7 & \inlineresponsebox[.5in]{8} & \inlineresponsebox[.5in]{9} \\
                8 & \inlineresponsebox[.5in]{10} & \inlineresponsebox[.5in]{13} \\
                9 & \inlineresponsebox[.5in]{11} & \inlineresponsebox[.5in]{12} \\
            \end{tabular}
        \end{center}
        \end{soln}
    \end{subprob}
