\begin{progprob}
    ...
    \begin{soln}
        We use DFS. We don't need to check whether a neighbor has been discovered
        when searching a tree, because there are no cycles.

        \inputminted{python}{\thisdir/include-solution/biggest_descendent.py}
    \end{soln}
\end{progprob}
