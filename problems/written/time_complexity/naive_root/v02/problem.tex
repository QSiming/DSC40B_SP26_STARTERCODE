\begin{prob}
    ...
    \begin{subprobset}
        \begin{subprob}
            ...
            \begin{soln}
                It computes, approximately, $n^{1/3}$. Of course, \python{foo}
                ...
                than or equal to the cubic root $n^{1/3}$. For example, $(10)^{1/3}$ is between 2 and 3;
                \python{foo(10)} returns 3.
            \end{soln}
        \end{subprob}
