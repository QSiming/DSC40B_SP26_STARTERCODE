\begin{figure}[h]
    ...
    \end{tikzpicture}
    \caption{\label{fig:graph} Graph for Problems 1 and 2.}
\end{figure}
...
\begin{prob}[\eligible]
    ...
    Figure~\ref{fig:graph}, starting with node $c$.
            ...
            that \python{graph.neighbors()} produces successors in ascending
            order of label.

            \begin{soln}
                Nodes $c,b,f,d,h,e,g$ are visited, in that order.
            \end{soln}
\end{prob}
